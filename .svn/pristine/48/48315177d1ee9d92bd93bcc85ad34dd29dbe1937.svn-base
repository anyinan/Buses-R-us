...
public class RouteParser {
    ...
    /**
     * Parse one route information from JSON response produced by Translink.
     * Stores all routes and route patterns found in the RouteManager.
     *
     * @param  route    JSONObject of route parsed by the Routes.
     * @throws JSONException   when JSON data does not have expected format
     * @throws RouteDataMissingException when
     * <ul>
     *  <li> JSON data is not an array </li>
    ...
    /**
     * Store the parsed Route into the named route
     *
     * @param routeNumber       the number of the route
     * @param routeName       the name of the route
     * @param patternNo          the number of Route pattern
     * @param destination          the destination of Route pattern
     * @param direction          the direction of Route pattern
     */
